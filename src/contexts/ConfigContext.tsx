...
const translations = {
  ...
  en: {
    ...
    readyToServeOrders: 'Listas para Servir',
    initiatePreparation: 'Iniciar Preparación',
    markOrderAsReady: 'Marcar como Lista',
    orderReceivedNotification: 'Orden recibida',
    orderDuration: 'Hace',
    minutesAgo: 'minutos',
    now: 'Ahora',
